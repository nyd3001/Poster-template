...
- `examples/icml_xiaomi_mecat/`：ICML + Xiaomi（[PNG 预览](examples/icml_xiaomi_mecat/main.png)）
- `examples/icml_xiaomi_mecat_light/`：ICML light + Xiaomi light（[PNG 预览](examples/icml_xiaomi_mecat_light/main.png)）
